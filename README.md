...
>
> We use standard naming conventions (like `field_website` or generic company names) rather than our specific internal database schema. This makes the tutorials easier to follow for everyone, regardless of what project you are working on.
...
* **[Part 4: Modifying YAML & CLI Commands](./04-modifying-yaml-cli.md)**
...
* **[Part 5: 10 Process Plugins I Frequently Used](./05-process-plugins.md)**
